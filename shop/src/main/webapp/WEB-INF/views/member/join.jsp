		...
		<form id="join_form" method="post">
			<div class="wrap">
				...
				<div class="pw_wrap">
					...
					<span class="final_pw_check">비밀번호를 입력하세요.</span>
				</div>
				<div class="pwck_wrap">
					...
					<span class="final_pwck_check">비밀번호 확인을 입력하세요.</span>
				</div>
				<div class="user_wrap">
					...
					<span class="final_user_check">이름을 입력하세요.</span>
				</div>
				<div class="mail_wrap">
					...
					<span class="final_mail_check">이메일을 입력하세요.</span>
				...
				<div class="address_wrap">
					...
					<div class="address_input_3_wrap">
						...
						<span class="final_addr_check">상세 주소를 입력하세요.</span>
					</div>
				</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(".join_button").click(function() {
				...
				//이름 확인 유효성 검사
				if (name == "") {
					$('.final_user_check').css('display', 'block');
					$('.user_input').focus();
					nameCheck = false;
				} else {
					$('.final_user_check').css('display', 'none');
					nameCheck = true;
				}
		...
		function mailFormCheck(email){
			var form = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/;
